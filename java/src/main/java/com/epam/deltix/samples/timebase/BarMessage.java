...
public class BarMessage extends InstrumentMessage {
    ...
    public void nullifyOpen() {
        this.open = TypeConstants.IEEE64_NULL;
    }
    ...
    public void nullifyHigh() {
        this.high = TypeConstants.IEEE64_NULL;
    }
    ...
    public void nullifyLow() {
        this.low = TypeConstants.IEEE64_NULL;
    }
    ...
    public void nullifyClose() {
        this.close = TypeConstants.IEEE64_NULL;
    }
    ...
    public void nullifyVolume() {
        this.volume = TypeConstants.IEEE64_NULL;
    }
    ...
    public BarMessage reset() {
        super.reset();
        open = TypeConstants.IEEE64_NULL;
        high = TypeConstants.IEEE64_NULL;
        low = TypeConstants.IEEE64_NULL;
        close = TypeConstants.IEEE64_NULL;
        volume = TypeConstants.IEEE64_NULL;
