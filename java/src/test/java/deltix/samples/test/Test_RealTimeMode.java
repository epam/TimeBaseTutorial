...
//    }
    ...
    public void testLive() throws InterruptedException, Introspector.IntrospectionException {
        ...
        populateStream(historicStream, new BarsGenerator(new GregorianCalendar(2010, 1, 1), (int) BarMessage.BAR_MINUTE, 100, "MSFT", "AAPL"));
        ...
        Thread liveStreamProducer = new Thread() {
            @Override
            public void run() {
                populateStream(liveStream, new BarsGenerator(GregorianCalendar.from(ZonedDateTime.now(ZoneId.systemDefault())), (int) BarMessage.BAR_MINUTE, 100, "Q", "W") {
                    int counter = 0;
                    @Override
                    public boolean next() {
                        counter++;
    ...
    public void testLive1() throws InterruptedException, Introspector.IntrospectionException {
        ...
        Thread producer = new Thread() {
            ...
            public void run() {
                BarsGenerator gn =
                    new BarsGenerator(new GregorianCalendar(), (int) BarMessage.BAR_MINUTE, 100, "QQQQ", "WWWW");
...
//                        "WWWW".equals(message.getSymbol().toString());
    ...
    public void testLive2() throws InterruptedException, Introspector.IntrospectionException {
        ...
        Thread producer = new Thread() {
            ...
            public void run() {
                BarsGenerator gn =
                    new BarsGenerator(null, (int) BarMessage.BAR_MINUTE, -1,
                            "QQQQ", "WWWW", "DDDD");
...
//        } while (cursor.next() && count < 10);
    ...
    public void testLiveHist() throws InterruptedException, Introspector.IntrospectionException {
        ...
        Thread producer = new Thread() {
            ...
            public void run() {
                BarsGenerator gn =
                    new BarsGenerator( new GregorianCalendar(2010, 1, 1), (int) BarMessage.BAR_MINUTE, 100, "QQQQ", "WWWW");
